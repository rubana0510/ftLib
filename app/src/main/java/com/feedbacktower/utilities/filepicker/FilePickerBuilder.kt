...
import com.feedbacktower.utilities.filepicker.models.sort.SortingTypes
...
class FilePickerBuilder {
    ...
    private fun start(context: Activity, requestCode: Int) {
        ...
        PickerManager.providerAuthorities = context.applicationContext.packageName + ".com.feedbacktower.utilities.filepicker.provider"
    ...
    private fun start(fragment: Fragment, requestCode: Int) {
        fragment.context?.let {
            ...
            PickerManager.providerAuthorities = it.applicationContext?.packageName + ".com.feedbacktower.utilities.filepicker.provider"
