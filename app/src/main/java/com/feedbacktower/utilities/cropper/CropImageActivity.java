...
public class CropImageActivity extends AppCompatActivity
    ...
    private void setClickHandlers() {
        findViewById(R.id.done).setOnClickListener(v -> {
            cropImage();
            ((FloatingActionButton) findViewById(R.id.done)).hide();
        });
        findViewById(R.id.rotate).setOnClickListener(v -> rotateImage(mOptions.rotationDegrees));
        findViewById(R.id.flip).setOnClickListener(v -> mCropImageView.flipImageHorizontally());
    }
